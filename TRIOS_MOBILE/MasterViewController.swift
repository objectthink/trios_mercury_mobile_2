...
class MasterViewController: UITableViewController {
   ...
   {
      let alert =
      UIAlertController(title: "Input", message: "Enter IP Address", preferredStyle: UIAlertControllerStyle.Alert)
      
      alert.addAction(UIAlertAction(title: "Enter", style: UIAlertActionStyle.Default, handler:
         {
            ...
            self.objects.insert(newName, atIndex: 0)
